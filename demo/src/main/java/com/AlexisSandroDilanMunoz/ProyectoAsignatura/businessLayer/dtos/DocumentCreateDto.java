...
public class DocumentCreateDto {
    ...
    @Schema(description = "Título del documento",
            example = "Contrato Marco 2024",
            required = true,
            maxLength = 300)
    private String title;

    @Schema(description = "Descripción del documento",
            example = "Contrato marco de servicios tecnológicos para el año 2024")
    private String description;

    @Schema(description = "ID del tipo documental al que pertenece este documento",
            example = "3",
            required = true)
